        ...
        <div class="row">
          <div class=" col-md-4">
            <ol>
              ...
              <li>Topic Wise Exam Result List</li>
            </ol>
          </div>
            ...
            <div class="card">
              <div class="card-header tabDesign">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    ?>
                    <li class="nav-item">
                      <a onclick="getResultByTopicWise('{{$t_topic_details_id}}','{{$t_exam_id}}')" class="nav-link active" data-toggle="tab" href="#Chapt1" role="tab">{{Controller::getTopicName($t_topic_details_id)}}</a>
                    </li>
                    <?php } ?>  
                </ul>
              </div>
...
<script>
    $( window ).on( "load", function() {
        ...
        getResultByTopicWise(t_id,t_ex_id);
    });
    function getResultByTopicWise(t_topic_details_id,t_exam_id){
      $('#questionDiv').empty();
      $('#questionNo').empty();
      $('.bs-example').hide();
      $('#img12').show();	
      $('.frmbtngroup').prop('disabled',true);			
			...
			$.ajax({
				url:baseUrl+'/home/resultdetailsbytopicselection',
				type: 'get',
				data:{
